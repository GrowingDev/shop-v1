  ...
  <div id="product__preview" class="w-full">
    <div id="preview__wrapper">
      <div class="flex flex-row justify-center w-full h-full">
        <button class="btn__product__preview btn-left" @click="front = !front">
          <svg
        ...
        <button class="btn__product__preview btn-right" @click="front = !front">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
            viewBox="0 0 24 24"
      ...
      <img id="degree" src="~/assets/icons/360.png" alt="" />
    </div>
    ...
    <button
      ...
      "
      :disabled="
        this.uploadFront.image == null || this.uploadBack.image == null
      "
    >
      jetzt bestellen
    </button>
